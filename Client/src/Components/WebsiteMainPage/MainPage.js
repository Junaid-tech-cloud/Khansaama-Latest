...
function MainPage(props) {
  ...
  useEffect(() => {
        ...
        method: 'get',
        url : "http://localhost:3000/role/chefs"
		})
    ...
    async function fetchChefDishes() {
      const url = `http://localhost:3000/food/find/`;
      ...
      <div className="row">
        <div className="col-lg-8">
          ...
          <div className="btns">
            ...
            <Link to = '/register' className="btn-book animated fadeInUp scrollto">Chef Registration</Link>
          </div>
        </div>
